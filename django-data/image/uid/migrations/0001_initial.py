...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('gene_bank_name', 'gene_bank_country', 'datasource_type', 'datasource_version', 'owner')},
            },
            bases=(uid.mixins.BaseMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='uid.DictCountry')),
                ('specie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='uid.DictSpecie')),
            ],
            options={
                'verbose_name': 'breed',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('biosample_id', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ...
                ('breed', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='uid.DictBreed')),
                ('father', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='father_of', to='uid.Animal')),
                ('mother', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mother_of', to='uid.Animal')),
                ...
                ('sex', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='uid.DictSex')),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animal_set', to='uid.Submission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='uid.Publication')),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_set', to='uid.Submission')),
            ],
            options={
